...
function searchResultsHTML(stores) {
  return stores.map(function (store) {
    //console.log(stores)
    return '<a href="/store/' + store.slug + '" class="search__result"><stong>' + store.name + '</strong></a>\n    ';
  }).join('');
}
function typeAhead(search) {
  ...
  searchInput.on('keyup', function (e) {
    ...
    //If they are not pressing up, dow, or enter who cares
